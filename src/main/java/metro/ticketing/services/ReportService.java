...
public class ReportService {
    ...
    public void showTotalSales() {
        ...
        System.out.printf("%-16s : %03d%n", "Single Ticket", singleCount); 
        System.out.printf("%-16s : %03d%n", "Daily Ticket", dailyCount); 
        System.out.printf("%-16s : %03d%n", "Monthly Ticket", monthlyCount); 
        func.printHeader("", '-');
        System.out.printf("%-16s : %03d%n", "Total Tickets", total); 
    ...
    public void showTotalRevenue() {
        ...
        System.out.printf("%-16s : RM%7.2f%n", "Single Ticket", singleRevenue);
        System.out.printf("%-16s : RM%7.2f%n", "Daily Ticket", dailyRevenue);
        System.out.printf("%-16s : RM%7.2f%n", "Monthly Ticket", monthlyRevenue);
        func.printHeader("", '-');
        System.out.printf("%-16s : RM%7.2f%n", "Total Revenue", totalRevenue);
    ...
    public void showCancelledTickets() {
        ...
        System.out.printf("%-28s : %03d%n", "Single Tickets Cancelled", singleTkCancelled);
        System.out.printf("%-28s : %03d%n", "Daily Tickets Cancelled", dailyTkCancelled);
        System.out.printf("%-28s : %03d%n", "Monthly Tickets Cancelled", monthlyTkCancelled);
        func.printHeader("", '-');
        System.out.printf("%-28s : %03d%n", "Total Cancelled Tickets", totalTkCancelled);
